            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('update-doctor/'.$doctor->id) }}" id="editDoctor"
                        ...
                        <div class="form-group row">
                            <label for="phone" class="col-md-4 col-form-label text-md-right">{{ __('Phone Contact') }}</label>

                            <div class="col-md-6">
                                <input id="phone" type="phone" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{$doctor->phone}}" required autocomplete="phone">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="charges" type="number" class="form-control @error('charges') is-invalid @enderror" name="charges" value="{{$doctor->charges}}" required autocomplete="charges">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="qualification" type="text" class="form-control @error('qualification') is-invalid @enderror" value="{{$doctor->qualification}}" name="qualification" required autocomplete="qualification">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control @error('status') is-invalid @enderror" id="status" name="status" value="{{$doctor->status}}" required autocomplete="status">

                                <option selected>{{$doctor->status}}</option>
